...
export const FICHA_LEE_LM = {
  ...
  preguntas: [
    ...
    },
    {
      ...
      group: "ANTES_LECTURA",
      texto:
        "¿Ha planteado estrategias para elaborar predicciones o lanzar hipótesis sobre el contenido del texto, a partir de los indicios que ofrece el texto que leerán las y los estudiantes?, con preguntas como: ¿Qué ideas tiene acerca del tema relacionado con el texto?, ¿Qué ideas ha manifestado el autor en otros de sus textos?, ¿de qué tratará el texto?, ¿por qué crees eso?, ¿Qué piensan ustedes? Dependiendo del tipo de texto que leerán las y los estudiantes.",
    },
    {
      id: "p04",
      numero: "04",
    ...
    },
    {
      ...
      group: "DURANTE_LECTURA",
      texto:
        "¿Ha planteado estrategias relacionados a aclarar el texto en determinados momentos del proceso de la lectura?",
    },
    {
      id: "p08",
      numero: "08",
      group: "DURANTE_LECTURA",
      texto:
        "¿Ha planteado estrategias para que las y los estudiantes, después de una lectura total del texto puedan aplicar algunas estrategias de comprensión como: el subrayado, sumillado, reconocimiento de las ideas principales por párrafos, realizar resumen, etc.?",
    },
    {
      id: "p09",
      numero: "09",
    ...
    // ---------------- DESPUÉS DE LA LECTURA (14-16) ----------------
    {
      id: "p14",
      numero: "14",
      group: "DESPUES_LECTURA",
      texto:
        "¿Ha planteado preguntas que demandan la necesidad en las y los estudiantes de ubicar o localizar información en el texto, que les permita a las y los estudiantes a encontrar las ideas principales, el orden de las acciones, los personajes principales y secundarios e identificar los párrafos del texto, etc.?",
    },
    {
      id: "p15",
      numero: "15",
      group: "DESPUES_LECTURA",
      texto:
        "¿Ha planteado preguntas que demandan en las y los estudiantes realizar inferencias en base al contenido del texto, con la finalidad de que las y los estudiantes reconstruye el significado del texto relacionándolo con sus experiencias personales y conocimientos previos, a partir de ello formula conjeturas e hipótesis y saca conclusiones, realiza interpretaciones?",
    },
    {
      id: "p16",
      numero: "16",
      group: "DESPUES_LECTURA",
      texto:
        "¿Ha planteado preguntas que demandan en las y los estudiantes en dar opiniones, reflexionar sobre el contenido o la forma, así como asumir una posición sobre el contenido del texto, con la finalidad de que las y los estudiantes emitan juicios y opiniones fundamentadas a partir de lo cual acepta o rechaza lo planteado por el autor?",
    },
